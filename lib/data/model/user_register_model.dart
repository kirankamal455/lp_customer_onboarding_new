...
class UserRegister {
  ...
  factory UserRegister.fromMap(Map<String, dynamic> map) {
    return UserRegister(
      ...
      documentExpiryDate: map['documentExpiryDate'] as String,
    );
  }
  ...
  @override
  String toString() {
    return 'UserRegister(fname: $fname, mname: $mname, lname: $lname, dob: $dob, gender: $gender, address: $address, photoidtype: $photoidtype, photoidimagepath: $photoidimagepath, documentExpiryDate: $documentExpiryDate)';
  }
