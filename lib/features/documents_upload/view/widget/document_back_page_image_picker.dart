...
class DocumentBackPageImagePicker extends StatelessWidget {
  const DocumentBackPageImagePicker({
    super.key,
  });
  ...
  Widget build(BuildContext context) {
    return Consumer(builder: (context, ref, child) {
      ...
      return FormBuilderImagePicker(
        ...
        decoration:
            const InputDecoration(labelText: 'Pick Document Back Page Image'),
        maxImages: 1,
        imageQuality: 50,
        previewHeight: 200,
        ...
        validator: FormBuilderValidators.required(
          errorText: "Please Pick Document Back Image",
        ),
      );
    });
  }
